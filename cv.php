...
$skills = [
 ...
 $workExperience = [
   ...
   [
     'jobTitle' => 'Web Developer / something.com',
     'periodFinish' => 'Mar 2012 - Dec 2014, ',
   ...
   [
     ...
     'periodFinish' => 'Jun 2010 - Mar 2012',
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        ...
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            <p><i class="fa fa-briefcase fa-fw w3-margin-right w3-large w3-text-teal"></i>Профессия:
              <?=$profi?>
            </p>
            ...
            <div class="w3-light-grey w3-round-xlarge w3-small">
              <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$skill ['value']?>%">
                <?=$skill ['value']?>%
              </div>
            </div>
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php foreach ($workExperience as $key => $workExperience): ?>
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
              ...
              <span class="w3-tag w3-teal w3-round">
                <?=$workExperience['periodFinish']?>
                <?php if ($key == 0):?> current
                <?php endif; ?>
              </span>
